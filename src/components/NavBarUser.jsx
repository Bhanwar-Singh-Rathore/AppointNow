...
function toasts() {
  ...
  return (
    ...
    <li><input type="text"  className=" border border-white-800 h-8 w-72 mt-4 ml-5 mb-4 rounded " placeholder="search here....."/></li>
    <Logout/>
      </ul>
 ...
 <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
    ...
    <ul className="  mb-2  mt-2  lg:mb-0 lg:mt-0 lg:items-center md:hidden  font-thin w-64   " >
        ...
        <li onClick={toasts} className=" ml-8  hover:bg-blue-500 active:bg-violet-700 focus:outline-none focus:ring focus:ring-black-300 br rounded px-4 py-1  border-b border-gray-200 "  ><Link to="">Learn</Link></li>
        <li onClick={toasts} className="ml-8 hover:bg-blue-500 active:bg-violet-700 focus:outline-none focus:ring focus:ring-black-300 br rounded px-4 py-1  border-b border-gray-200 " ><Link to="">Integrations</Link></li>
        <li onClick={toasts} className=" ml-8 hover:bg-blue-500 active:bg-violet-700 focus:outline-none focus:ring focus:ring-black-300 br rounded px-4 py-1  border-b border-gray-200 " > <Link to="">Features</Link></li>
        <li  onClick={toasts} className=" ml-8 hover:bg-blue-500 active:bg-violet-700 focus:outline-none focus:ring    border-b border-gray-200 
      focus:ring-black-300 br rounded  px-4 py-1" ><Link to="">Industries</Link></li>
