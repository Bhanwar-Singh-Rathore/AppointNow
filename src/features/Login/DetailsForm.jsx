...
export function DetailsForm() {
  ...
  return (
    <div className="flex justify-center mr-20">
      <form onSubmit={handleSubmit(handleSubmits)} className="flex-col mt-6 ">
        <p className="mt-2 mb-10 flex justify-center  text-2xl ">
        ...
        <div> */}
          ...
          {/* <input type="hidden" value={user} {...register('id')}/> */}
          <label className="mt-2">Bussiness Name</label>
          <div>
            <input
              {...register("bussiness_name")}
              className=" border border-white-800 h-14 w-[450px] rounded-xl mt-4 focus:outline-none  focus:border-blue-400 hover:border-blue-400 border-1 mb-4  "
        ...
        <label className="mt-4">Shop Address</label>
        <div>
          <input
            className=" border border-white-800 h-14 w-[450px] rounded-xl mt-4 focus:outline-none  focus:border-blue-400 hover:border-blue-400 border-1 mb-4  "
